...
;
;--------------------------------------------------------------------------------------
; void mmx_absdiff(unsigned char *src1, unsigned char *src2, unsigned char *dst, int num_quadwords);
;
; Absolute difference between two one-dimensional byte arrays, using MMX registers
;
