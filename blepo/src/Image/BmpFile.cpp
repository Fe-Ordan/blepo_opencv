						...
						UINT *height)
{
	...
	*width=0; *height=0;
	...
	if (fp==NULL) {
		...
		case 32:
      return NULL;  // sorry, 32 bits not implemented (would be easy to do, though)
			break;
		case 24:
			break;
			// read pallete 
...
//  
//  Minor change made by Prashant Oswal, Feb 2005:
//     - Now the function returns TRUE upon success or FALSE
