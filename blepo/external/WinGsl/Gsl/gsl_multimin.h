...
WINGSLDLL_API int gsl_multimin_diff (const gsl_multimin_function * f,
...
WINGSLDLL_API gsl_multimin_fminimizer *
...
WINGSLDLL_API gsl_multimin_fdfminimizer *
