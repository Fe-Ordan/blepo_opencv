...
WINGSLDLL_API gsl_min_fminimizer *
gsl_min_fminimizer_alloc (const gsl_min_fminimizer_type * T) ;
                                      
WINGSLDLL_API void gsl_min_fminimizer_free (gsl_min_fminimizer * s);

WINGSLDLL_API int gsl_min_fminimizer_set (gsl_min_fminimizer * s, 
                            gsl_function * f, double x_minimum, 
                            double x_lower, double x_upper);

WINGSLDLL_API int gsl_min_fminimizer_set_with_values (gsl_min_fminimizer * s, 
                                        gsl_function * f, 
                                        double x_minimum, double f_minimum,
                                        double x_lower, double f_lower,
                                        double x_upper, double f_upper);

WINGSLDLL_API int gsl_min_fminimizer_iterate (gsl_min_fminimizer * s);

WINGSLDLL_API const char * gsl_min_fminimizer_name (const gsl_min_fminimizer * s);

WINGSLDLL_API double gsl_min_fminimizer_x_minimum (const gsl_min_fminimizer * s);
WINGSLDLL_API double gsl_min_fminimizer_x_lower (const gsl_min_fminimizer * s);
WINGSLDLL_API double gsl_min_fminimizer_x_upper (const gsl_min_fminimizer * s);
WINGSLDLL_API double gsl_min_fminimizer_f_minimum (const gsl_min_fminimizer * s);
WINGSLDLL_API double gsl_min_fminimizer_f_lower (const gsl_min_fminimizer * s);
WINGSLDLL_API double gsl_min_fminimizer_f_upper (const gsl_min_fminimizer * s);

/* Deprecated, use x_minimum instead */
WINGSLDLL_API double gsl_min_fminimizer_minimum (const gsl_min_fminimizer * s);
