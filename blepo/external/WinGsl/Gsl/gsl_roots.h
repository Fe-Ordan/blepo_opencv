...
WINGSLDLL_API gsl_root_fsolver *
gsl_root_fsolver_alloc (const gsl_root_fsolver_type * T);
WINGSLDLL_API void gsl_root_fsolver_free (gsl_root_fsolver * s);

WINGSLDLL_API int gsl_root_fsolver_set (gsl_root_fsolver * s,
                          gsl_function * f, 
                          double x_lower, double x_upper);

WINGSLDLL_API int gsl_root_fsolver_iterate (gsl_root_fsolver * s);

WINGSLDLL_API const char * gsl_root_fsolver_name (const gsl_root_fsolver * s);
WINGSLDLL_API double gsl_root_fsolver_root (const gsl_root_fsolver * s);
WINGSLDLL_API double gsl_root_fsolver_x_lower (const gsl_root_fsolver * s);
WINGSLDLL_API double gsl_root_fsolver_x_upper (const gsl_root_fsolver * s);


WINGSLDLL_API gsl_root_fdfsolver *
...
WINGSLDLL_API const char * gsl_root_fdfsolver_name (const gsl_root_fdfsolver * s);
WINGSLDLL_API double gsl_root_fdfsolver_root (const gsl_root_fdfsolver * s);
