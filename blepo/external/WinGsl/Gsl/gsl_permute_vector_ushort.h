...
WINGSLDLL_API int gsl_permute_vector_ushort (const gsl_permutation * p, gsl_vector_ushort * v);
WINGSLDLL_API int gsl_permute_vector_ushort_inverse (const gsl_permutation * p, gsl_vector_ushort * v);
