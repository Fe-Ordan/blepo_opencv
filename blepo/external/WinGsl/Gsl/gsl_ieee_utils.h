...
WINGSLDLL_API void gsl_ieee_printf_float (const float * x) ;
WINGSLDLL_API void gsl_ieee_printf_double (const double * x) ;

WINGSLDLL_API void gsl_ieee_fprintf_float (FILE * stream, const float * x) ;
WINGSLDLL_API void gsl_ieee_fprintf_double (FILE * stream, const double * x) ;

WINGSLDLL_API void gsl_ieee_float_to_rep (const float * x, gsl_ieee_float_rep * r) ;
WINGSLDLL_API void gsl_ieee_double_to_rep (const double * x, gsl_ieee_double_rep * r) ;
...
WINGSLDLL_API void gsl_ieee_env_setup (void) ;
WINGSLDLL_API int gsl_ieee_read_mode_string (const char * description, int * precision,
                               int * rounding, int * exception_mask) ;
WINGSLDLL_API int gsl_ieee_set_mode (int precision, int rounding, int exception_mask) ;
