...
WINGSLDLL_API int gsl_permute_vector_long (const gsl_permutation * p, gsl_vector_long * v);
WINGSLDLL_API int gsl_permute_vector_long_inverse (const gsl_permutation * p, gsl_vector_long * v);
