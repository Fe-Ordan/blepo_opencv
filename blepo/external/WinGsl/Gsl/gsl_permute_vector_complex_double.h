...
WINGSLDLL_API int gsl_permute_vector_complex (const gsl_permutation * p, gsl_vector_complex * v);
WINGSLDLL_API int gsl_permute_vector_complex_inverse (const gsl_permutation * p, gsl_vector_complex * v);
