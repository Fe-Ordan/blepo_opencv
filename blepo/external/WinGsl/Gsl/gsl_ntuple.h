...
WINGSLDLL_API gsl_ntuple * 
gsl_ntuple_open (char * filename, void * ntuple_data, size_t size);

WINGSLDLL_API gsl_ntuple * 
gsl_ntuple_create (char * filename, void * ntuple_data, size_t size);

WINGSLDLL_API int gsl_ntuple_write (gsl_ntuple * ntuple);
WINGSLDLL_API int gsl_ntuple_read (gsl_ntuple * ntuple);

WINGSLDLL_API int gsl_ntuple_bookdata (gsl_ntuple * ntuple);  /* synonym for write */

WINGSLDLL_API int gsl_ntuple_project (gsl_histogram * h, gsl_ntuple * ntuple, 
                        gsl_ntuple_value_fn *value_func,
                        gsl_ntuple_select_fn *select_func);

WINGSLDLL_API int gsl_ntuple_close (gsl_ntuple * ntuple);
