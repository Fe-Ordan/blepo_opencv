 ...
 */
WINGSLDLL_API int gsl_sf_hydrogenicR_1_e(const double Z, const double r, gsl_sf_result * result);
WINGSLDLL_API double gsl_sf_hydrogenicR_1(const double Z, const double r);

/* R_n := norm exp(-Z r/n) (2Z/n)^l Laguerre[n-l-1, 2l+1, 2Z/n r]
 *
 * normalization such that psi(n,l,r) = R_n Y_{lm}
 */
WINGSLDLL_API int gsl_sf_hydrogenicR_e(const int n, const int l, const double Z, const double r, gsl_sf_result * result);
WINGSLDLL_API double gsl_sf_hydrogenicR(const int n, const int l, const double Z, const double r);
...
/* F_L(eta,x) as array */
WINGSLDLL_API int gsl_sf_coulomb_wave_F_array(
...
WINGSLDLL_API int gsl_sf_coulomb_wave_FG_array(double lam_min, int kmax,
                                double eta, double x,
...
WINGSLDLL_API int gsl_sf_coulomb_wave_FGp_array(double lam_min, int kmax,
                                double eta, double x,
 ...
 */
WINGSLDLL_API int gsl_sf_coulomb_wave_sphF_array(double lam_min, int kmax,
                                        double eta, double x,
                                        double * fc_array,
                                        double * F_exponent
                                        );
 ...
 */
WINGSLDLL_API int gsl_sf_coulomb_CL_e(double L, double eta, gsl_sf_result * result);
WINGSLDLL_API int gsl_sf_coulomb_CL_array(double Lmin, int kmax, double eta, double * cl);
