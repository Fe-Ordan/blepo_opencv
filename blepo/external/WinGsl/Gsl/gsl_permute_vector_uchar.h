...
WINGSLDLL_API int gsl_permute_vector_uchar (const gsl_permutation * p, gsl_vector_uchar * v);
WINGSLDLL_API int gsl_permute_vector_uchar_inverse (const gsl_permutation * p, gsl_vector_uchar * v);
