 ...
 */
WINGSLDLL_API gsl_odeiv_step * gsl_odeiv_step_alloc(const gsl_odeiv_step_type * T, size_t dim);
WINGSLDLL_API int  gsl_odeiv_step_reset(gsl_odeiv_step * s);
WINGSLDLL_API void gsl_odeiv_step_free(gsl_odeiv_step * s);

/* General stepper object methods.
 */
WINGSLDLL_API const char * gsl_odeiv_step_name(const gsl_odeiv_step *);
WINGSLDLL_API unsigned int gsl_odeiv_step_order(const gsl_odeiv_step * s);

WINGSLDLL_API int  gsl_odeiv_step_apply(gsl_odeiv_step *, double t, double h, double y[], double yerr[], const double dydt_in[], double dydt_out[], const gsl_odeiv_system * dydt);
...
WINGSLDLL_API gsl_odeiv_control * gsl_odeiv_control_alloc(const gsl_odeiv_control_type * T);
WINGSLDLL_API int gsl_odeiv_control_init(gsl_odeiv_control * c, double eps_abs, double eps_rel, double a_y, double a_dydt);
WINGSLDLL_API void gsl_odeiv_control_free(gsl_odeiv_control * c);
WINGSLDLL_API int gsl_odeiv_control_hadjust (gsl_odeiv_control * c, gsl_odeiv_step * s, const double y0[], const double yerr[], const double dydt[], double * h);
WINGSLDLL_API const char * gsl_odeiv_control_name(const gsl_odeiv_control * c);
...
WINGSLDLL_API gsl_odeiv_control * gsl_odeiv_control_standard_new(double eps_abs, double eps_rel, double a_y, double a_dydt);
WINGSLDLL_API gsl_odeiv_control * gsl_odeiv_control_y_new(double eps_abs, double eps_rel);
WINGSLDLL_API gsl_odeiv_control * gsl_odeiv_control_yp_new(double eps_abs, double eps_rel);
 ...
 */
WINGSLDLL_API gsl_odeiv_control * gsl_odeiv_control_scaled_new(double eps_abs, double eps_rel, double a_y, double a_dydt, const double scale_abs[], size_t dim);
 ...
 */
WINGSLDLL_API gsl_odeiv_evolve * gsl_odeiv_evolve_alloc(size_t dim);
WINGSLDLL_API int gsl_odeiv_evolve_apply(gsl_odeiv_evolve *, gsl_odeiv_control * con, gsl_odeiv_step * step, const gsl_odeiv_system * dydt, double * t, double t1, double * h, double y[]);
WINGSLDLL_API int gsl_odeiv_evolve_reset(gsl_odeiv_evolve *);
WINGSLDLL_API void gsl_odeiv_evolve_free(gsl_odeiv_evolve *);
