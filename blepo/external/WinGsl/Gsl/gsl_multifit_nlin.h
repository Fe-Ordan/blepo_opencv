...
WINGSLDLL_API int gsl_multifit_gradient (const gsl_matrix * J, const gsl_vector * f,
                           gsl_vector * g);

WINGSLDLL_API int gsl_multifit_covar (const gsl_matrix * J, double epsrel, gsl_matrix * covar);
...
WINGSLDLL_API int gsl_multifit_fdjacobian (gsl_multifit_function * F,
                             const gsl_vector * x, 
                             const gsl_vector * f,
...
WINGSLDLL_API gsl_multifit_fsolver *
gsl_multifit_fsolver_alloc (const gsl_multifit_fsolver_type * T, 
                            size_t n, size_t p);

WINGSLDLL_API void gsl_multifit_fsolver_free (gsl_multifit_fsolver * s);

WINGSLDLL_API int gsl_multifit_fsolver_set (gsl_multifit_fsolver * s, 
                                   gsl_multifit_function * f, 
                                   gsl_vector * x);

WINGSLDLL_API int gsl_multifit_fsolver_iterate (gsl_multifit_fsolver * s);

WINGSLDLL_API const char * gsl_multifit_fsolver_name (const gsl_multifit_fsolver * s);
WINGSLDLL_API gsl_vector * gsl_multifit_fsolver_position (const gsl_multifit_fsolver * s);
...
WINGSLDLL_API gsl_multifit_fdfsolver *
...
WINGSLDLL_API const char * gsl_multifit_fdfsolver_name (const gsl_multifit_fdfsolver * s);
WINGSLDLL_API gsl_vector * gsl_multifit_fdfsolver_position (const gsl_multifit_fdfsolver * s);

WINGSLDLL_API int gsl_multifit_test_delta (const gsl_vector * dx, const gsl_vector * x, 
                             double epsabs, double epsrel);

WINGSLDLL_API int gsl_multifit_test_gradient (const gsl_vector * g, double epsabs);
