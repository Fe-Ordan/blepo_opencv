...
WINGSLDLL_API void gsl_error (const char * reason, const char * file, int line,
                int gsl_errno);

WINGSLDLL_API void gsl_stream_printf (const char *label, const char *file,
                        int line, const char *reason);

WINGSLDLL_API const char * gsl_strerror (const int gsl_errno);

WINGSLDLL_API typedef void gsl_error_handler_t (const char * reason, const char * file,
                                  int line, int gsl_errno);

WINGSLDLL_API typedef void gsl_stream_handler_t (const char * label, const char * file,
                                   int line, const char * reason);

WINGSLDLL_API gsl_error_handler_t * 
gsl_set_error_handler (gsl_error_handler_t * new_handler);

WINGSLDLL_API gsl_error_handler_t *
gsl_set_error_handler_off (void);

WINGSLDLL_API gsl_stream_handler_t * 
gsl_set_stream_handler (gsl_stream_handler_t * new_handler);

WINGSLDLL_API FILE * gsl_set_stream (FILE * new_stream);
