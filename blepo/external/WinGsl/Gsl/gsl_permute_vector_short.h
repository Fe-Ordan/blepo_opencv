...
WINGSLDLL_API int gsl_permute_vector_short (const gsl_permutation * p, gsl_vector_short * v);
WINGSLDLL_API int gsl_permute_vector_short_inverse (const gsl_permutation * p, gsl_vector_short * v);
