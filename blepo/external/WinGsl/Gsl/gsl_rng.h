...
WINGSLDLL_API const gsl_rng_type ** gsl_rng_types_setup(void);

GSL_VAR const gsl_rng_type *gsl_rng_default;
GSL_VAR unsigned long int gsl_rng_default_seed;

WINGSLDLL_API gsl_rng *gsl_rng_alloc (const gsl_rng_type * T);
WINGSLDLL_API int gsl_rng_memcpy (gsl_rng * dest, const gsl_rng * src);
WINGSLDLL_API gsl_rng *gsl_rng_clone (const gsl_rng * r);

WINGSLDLL_API void gsl_rng_free (gsl_rng * r);

WINGSLDLL_API void gsl_rng_set (const gsl_rng * r, unsigned long int seed);
WINGSLDLL_API unsigned long int gsl_rng_max (const gsl_rng * r);
WINGSLDLL_API unsigned long int gsl_rng_min (const gsl_rng * r);
WINGSLDLL_API const char *gsl_rng_name (const gsl_rng * r);

WINGSLDLL_API int gsl_rng_fread (FILE * stream, gsl_rng * r);
WINGSLDLL_API int gsl_rng_fwrite (FILE * stream, const gsl_rng * r);

WINGSLDLL_API size_t gsl_rng_size (const gsl_rng * r);
WINGSLDLL_API void * gsl_rng_state (const gsl_rng * r);

WINGSLDLL_API void gsl_rng_print_state (const gsl_rng * r);

WINGSLDLL_API const gsl_rng_type * gsl_rng_env_setup (void);

WINGSLDLL_API unsigned long int gsl_rng_get (const gsl_rng * r);
WINGSLDLL_API double gsl_rng_uniform (const gsl_rng * r);
WINGSLDLL_API double gsl_rng_uniform_pos (const gsl_rng * r);
WINGSLDLL_API unsigned long int gsl_rng_uniform_int (const gsl_rng * r, unsigned long int n);
