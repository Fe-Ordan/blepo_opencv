...
WINGSLDLL_API int gsl_monte_vegas_integrate(gsl_monte_function * f, 
                              double xl[], double xu[], 
...
WINGSLDLL_API gsl_monte_vegas_state* gsl_monte_vegas_alloc(size_t dim);

WINGSLDLL_API int gsl_monte_vegas_init(gsl_monte_vegas_state* state);

WINGSLDLL_API void gsl_monte_vegas_free (gsl_monte_vegas_state* state);
