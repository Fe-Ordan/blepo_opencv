...
#else
WINGSLDLL_API double gsl_pow_2(const double x);
WINGSLDLL_API double gsl_pow_3(const double x);
WINGSLDLL_API double gsl_pow_4(const double x);
WINGSLDLL_API double gsl_pow_5(const double x);
WINGSLDLL_API double gsl_pow_6(const double x);
WINGSLDLL_API double gsl_pow_7(const double x);
WINGSLDLL_API double gsl_pow_8(const double x);
WINGSLDLL_API double gsl_pow_9(const double x);
#endif

WINGSLDLL_API double gsl_pow_int(double x, int n);
