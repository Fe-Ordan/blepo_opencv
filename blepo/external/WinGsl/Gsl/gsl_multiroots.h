...
WINGSLDLL_API int gsl_multiroot_fdjacobian (gsl_multiroot_function * F,
...
WINGSLDLL_API gsl_multiroot_fsolver * 
gsl_multiroot_fsolver_alloc (const gsl_multiroot_fsolver_type * T, 
                                     size_t n); 

WINGSLDLL_API void gsl_multiroot_fsolver_free (gsl_multiroot_fsolver * s);

WINGSLDLL_API int gsl_multiroot_fsolver_set (gsl_multiroot_fsolver * s, 
                               gsl_multiroot_function * f, gsl_vector * x);

WINGSLDLL_API int gsl_multiroot_fsolver_iterate (gsl_multiroot_fsolver * s);

WINGSLDLL_API const char * gsl_multiroot_fsolver_name (const gsl_multiroot_fsolver * s);
WINGSLDLL_API gsl_vector * gsl_multiroot_fsolver_root (const gsl_multiroot_fsolver * s);
WINGSLDLL_API gsl_vector * gsl_multiroot_fsolver_dx (const gsl_multiroot_fsolver * s);
WINGSLDLL_API gsl_vector * gsl_multiroot_fsolver_f (const gsl_multiroot_fsolver * s);
...
WINGSLDLL_API gsl_multiroot_fdfsolver *
...
WINGSLDLL_API const char * gsl_multiroot_fdfsolver_name (const gsl_multiroot_fdfsolver * s);
WINGSLDLL_API gsl_vector * gsl_multiroot_fdfsolver_root (const gsl_multiroot_fdfsolver * s);
WINGSLDLL_API gsl_vector * gsl_multiroot_fdfsolver_dx (const gsl_multiroot_fdfsolver * s);
WINGSLDLL_API gsl_vector * gsl_multiroot_fdfsolver_f (const gsl_multiroot_fdfsolver * s);

WINGSLDLL_API int gsl_multiroot_test_delta (const gsl_vector * dx, const gsl_vector * x, 
                              double epsabs, double epsrel);

WINGSLDLL_API int gsl_multiroot_test_residual (const gsl_vector * f, double epsabs);
