 ...
 */
WINGSLDLL_API int     gsl_sf_dilog_e(const double x, gsl_sf_result * result);
WINGSLDLL_API double     gsl_sf_dilog(const double x);


/* DiLogarithm(z), for complex argument z = r Exp[i theta].
 */
WINGSLDLL_API int gsl_sf_complex_dilog_e(const double r, double theta, gsl_sf_result * result_re, gsl_sf_result * result_im);
