 ...
 * space dimension.
 */
WINGSLDLL_API gsl_qrng * gsl_qrng_alloc (const gsl_qrng_type * T, unsigned int dimension);


/* Copy a generator. */
WINGSLDLL_API int gsl_qrng_memcpy (gsl_qrng * dest, const gsl_qrng * src);


/* Clone a generator. */
WINGSLDLL_API gsl_qrng * gsl_qrng_clone (const gsl_qrng * r);


/* Free a generator. */
WINGSLDLL_API void gsl_qrng_free (gsl_qrng * r);


/* Intialize a generator. */
WINGSLDLL_API void gsl_qrng_init (gsl_qrng * r);


/* Get the standardized name of the generator. */
WINGSLDLL_API const char * gsl_qrng_name (const gsl_qrng * r);


/* ISN'T THIS CONFUSING FOR PEOPLE?
  WHAT IF SOMEBODY TRIES TO COPY WITH THIS ???
  */
WINGSLDLL_API size_t gsl_qrng_size (const gsl_qrng * r);


WINGSLDLL_API void * gsl_qrng_state (const gsl_qrng * r);


/* Retrieve next vector in sequence. */
WINGSLDLL_API int gsl_qrng_get (const gsl_qrng * r, double x[]);
