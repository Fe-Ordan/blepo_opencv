...
WINGSLDLL_API gsl_sum_levin_u_workspace *gsl_sum_levin_u_alloc (size_t n);
WINGSLDLL_API void gsl_sum_levin_u_free (gsl_sum_levin_u_workspace * w);
...
WINGSLDLL_API int gsl_sum_levin_u_accel (const double *array,
                           const size_t n,
...
WINGSLDLL_API int gsl_sum_levin_u_minmax (const double *array,
                            const size_t n,
...
WINGSLDLL_API gsl_sum_levin_utrunc_workspace *gsl_sum_levin_utrunc_alloc (size_t n);
WINGSLDLL_API void gsl_sum_levin_utrunc_free (gsl_sum_levin_utrunc_workspace * w);

WINGSLDLL_API int gsl_sum_levin_utrunc_accel (const double *array,
                                const size_t n,
                                gsl_sum_levin_utrunc_workspace * w,
                                double *sum_accel, double *abserr_trunc);

WINGSLDLL_API int gsl_sum_levin_utrunc_minmax (const double *array,
                                 const size_t n,
                                 const size_t min_terms,
                                 const size_t max_terms,
                                 gsl_sum_levin_utrunc_workspace * w,
...
WINGSLDLL_API int gsl_sum_levin_utrunc_step (const double term,
                               const size_t n,
                               gsl_sum_levin_utrunc_workspace * w, 
                               double *sum_accel);
