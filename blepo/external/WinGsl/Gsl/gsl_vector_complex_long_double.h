...
WINGSLDLL_API gsl_vector_complex_long_double *gsl_vector_complex_long_double_alloc (const size_t n);
WINGSLDLL_API gsl_vector_complex_long_double *gsl_vector_complex_long_double_calloc (const size_t n);
...
WINGSLDLL_API void gsl_vector_complex_long_double_free (gsl_vector_complex_long_double * v);
...
WINGSLDLL_API gsl_complex_long_double 
gsl_vector_complex_long_double_get (const gsl_vector_complex_long_double * v, const size_t i);

WINGSLDLL_API void gsl_vector_complex_long_double_set (gsl_vector_complex_long_double * v, const size_t i,
                                   gsl_complex_long_double z);

WINGSLDLL_API gsl_complex_long_double 
*gsl_vector_complex_long_double_ptr (gsl_vector_complex_long_double * v, const size_t i);

WINGSLDLL_API const gsl_complex_long_double 
*gsl_vector_complex_long_double_const_ptr (const gsl_vector_complex_long_double * v, const size_t i);

WINGSLDLL_API void gsl_vector_complex_long_double_set_zero (gsl_vector_complex_long_double * v);
WINGSLDLL_API void gsl_vector_complex_long_double_set_all (gsl_vector_complex_long_double * v,
                                       gsl_complex_long_double z);
WINGSLDLL_API int gsl_vector_complex_long_double_set_basis (gsl_vector_complex_long_double * v, size_t i);

WINGSLDLL_API int gsl_vector_complex_long_double_fread (FILE * stream,
                                    gsl_vector_complex_long_double * v);
WINGSLDLL_API int gsl_vector_complex_long_double_fwrite (FILE * stream,
                                     const gsl_vector_complex_long_double * v);
WINGSLDLL_API int gsl_vector_complex_long_double_fscanf (FILE * stream,
                                     gsl_vector_complex_long_double * v);
WINGSLDLL_API int gsl_vector_complex_long_double_fprintf (FILE * stream,
                                      const gsl_vector_complex_long_double * v,
                                      const char *format);

WINGSLDLL_API int gsl_vector_complex_long_double_memcpy (gsl_vector_complex_long_double * dest, const gsl_vector_complex_long_double * src);

WINGSLDLL_API int gsl_vector_complex_long_double_reverse (gsl_vector_complex_long_double * v);

WINGSLDLL_API int gsl_vector_complex_long_double_swap (gsl_vector_complex_long_double * v, gsl_vector_complex_long_double * w);
WINGSLDLL_API int gsl_vector_complex_long_double_swap_elements (gsl_vector_complex_long_double * v, const size_t i, const size_t j);

WINGSLDLL_API int gsl_vector_complex_long_double_isnull (const gsl_vector_complex_long_double * v);
