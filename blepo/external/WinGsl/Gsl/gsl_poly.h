 ...
 * exceptions: none
 */
WINGSLDLL_API double gsl_poly_eval(const double c[], const int len, const double x);
 ...
 */
WINGSLDLL_API int gsl_poly_solve_quadratic (double a, double b, double c, 
                              double * x0, double * x1);
 ...
 * Roots are returned ordered.
 */
WINGSLDLL_API int gsl_poly_solve_cubic (double a, double b, double c, 
...
WINGSLDLL_API gsl_poly_complex_workspace * gsl_poly_complex_workspace_alloc (size_t n);
WINGSLDLL_API void gsl_poly_complex_workspace_free (gsl_poly_complex_workspace * w);
