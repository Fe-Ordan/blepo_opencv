...
WINGSLDLL_API int gsl_permute_vector_complex_float (const gsl_permutation * p, gsl_vector_complex_float * v);
WINGSLDLL_API int gsl_permute_vector_complex_float_inverse (const gsl_permutation * p, gsl_vector_complex_float * v);
