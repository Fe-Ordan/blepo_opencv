...
WINGSLDLL_API int gsl_permute_vector (const gsl_permutation * p, gsl_vector * v);
WINGSLDLL_API int gsl_permute_vector_inverse (const gsl_permutation * p, gsl_vector * v);
