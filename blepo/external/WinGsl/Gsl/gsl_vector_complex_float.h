...
WINGSLDLL_API gsl_vector_complex_float *gsl_vector_complex_float_alloc (const size_t n);
WINGSLDLL_API gsl_vector_complex_float *gsl_vector_complex_float_calloc (const size_t n);
...
WINGSLDLL_API void gsl_vector_complex_float_free (gsl_vector_complex_float * v);
...
WINGSLDLL_API gsl_complex_float 
gsl_vector_complex_float_get (const gsl_vector_complex_float * v, const size_t i);

WINGSLDLL_API void gsl_vector_complex_float_set (gsl_vector_complex_float * v, const size_t i,
                                   gsl_complex_float z);

WINGSLDLL_API gsl_complex_float 
*gsl_vector_complex_float_ptr (gsl_vector_complex_float * v, const size_t i);

WINGSLDLL_API const gsl_complex_float 
*gsl_vector_complex_float_const_ptr (const gsl_vector_complex_float * v, const size_t i);

WINGSLDLL_API void gsl_vector_complex_float_set_zero (gsl_vector_complex_float * v);
WINGSLDLL_API void gsl_vector_complex_float_set_all (gsl_vector_complex_float * v,
                                       gsl_complex_float z);
WINGSLDLL_API int gsl_vector_complex_float_set_basis (gsl_vector_complex_float * v, size_t i);

WINGSLDLL_API int gsl_vector_complex_float_fread (FILE * stream,
                                    gsl_vector_complex_float * v);
WINGSLDLL_API int gsl_vector_complex_float_fwrite (FILE * stream,
                                     const gsl_vector_complex_float * v);
WINGSLDLL_API int gsl_vector_complex_float_fscanf (FILE * stream,
                                     gsl_vector_complex_float * v);
WINGSLDLL_API int gsl_vector_complex_float_fprintf (FILE * stream,
                                      const gsl_vector_complex_float * v,
                                      const char *format);

WINGSLDLL_API int gsl_vector_complex_float_memcpy (gsl_vector_complex_float * dest, const gsl_vector_complex_float * src);

WINGSLDLL_API int gsl_vector_complex_float_reverse (gsl_vector_complex_float * v);

WINGSLDLL_API int gsl_vector_complex_float_swap (gsl_vector_complex_float * v, gsl_vector_complex_float * w);
WINGSLDLL_API int gsl_vector_complex_float_swap_elements (gsl_vector_complex_float * v, const size_t i, const size_t j);

WINGSLDLL_API int gsl_vector_complex_float_isnull (const gsl_vector_complex_float * v);
