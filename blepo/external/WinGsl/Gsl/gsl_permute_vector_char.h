...
WINGSLDLL_API int gsl_permute_vector_char (const gsl_permutation * p, gsl_vector_char * v);
WINGSLDLL_API int gsl_permute_vector_char_inverse (const gsl_permutation * p, gsl_vector_char * v);
