 ...
 * Return 0 on failure.
 */
WINGSLDLL_API gsl_cheb_series * gsl_cheb_alloc(const size_t order);

/* Free a Chebyshev series previously calculated with gsl_cheb_alloc().
 */
WINGSLDLL_API void gsl_cheb_free(gsl_cheb_series * cs);
 ...
 *
 */
WINGSLDLL_API int gsl_cheb_init(gsl_cheb_series * cs, const gsl_function * func,
 ...
 */
WINGSLDLL_API double gsl_cheb_eval(const gsl_cheb_series * cs, const double x);
WINGSLDLL_API int gsl_cheb_eval_err(const gsl_cheb_series * cs, const double x, 
 ...
 * No errors can occur for a struct obtained from gsl_cheb_new().
 */
WINGSLDLL_API double gsl_cheb_eval_n(const gsl_cheb_series * cs, const size_t order, 
                       const double x);
WINGSLDLL_API int gsl_cheb_eval_n_err(const gsl_cheb_series * cs, const size_t order, 
 ...
 * No errors can occur for a struct obtained from gsl_cheb_new().
 */
WINGSLDLL_API double gsl_cheb_eval_mode(const gsl_cheb_series * cs, double x, gsl_mode_t mode);
WINGSLDLL_API int gsl_cheb_eval_mode_e(const gsl_cheb_series * cs, const double x, gsl_mode_t mode, double * result, double * abserr);



/* Compute the derivative of a Chebyshev series.
 */
WINGSLDLL_API int gsl_cheb_calc_deriv(gsl_cheb_series * deriv, const gsl_cheb_series * cs);
 ...
 */
WINGSLDLL_API int gsl_cheb_calc_integ(gsl_cheb_series * integ, const gsl_cheb_series * cs);
