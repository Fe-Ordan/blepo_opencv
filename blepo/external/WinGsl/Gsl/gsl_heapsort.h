...
WINGSLDLL_API void gsl_heapsort (void * array, size_t count, size_t size, gsl_comparison_fn_t compare);
WINGSLDLL_API int gsl_heapsort_index (size_t * p, const void * array, size_t count, size_t size, gsl_comparison_fn_t compare);
